...
**How-to guides for implementing grammar-correction guarantees.**
...
| Document | Purpose |
|----------|---------|
| [implementing-guarantees.md](implementing-guarantees.md) | Translates the theoretical correction guarantees into concrete implementation steps and invariants to uphold. |
