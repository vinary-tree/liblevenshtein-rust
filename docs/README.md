...
Complete documentation for **liblevenshtein-rust v4.0.0-rc.2** — Levenshtein and
...
**Last Updated:** 2026-08-24  ·  **Version:** 4.0.0-rc.2
...
> or architecture of liblevenshtein v4.0.0-rc.2 — something you would consult to *use
...
- [Release evidence ledgers](releases/README.md) — immutable source commits,
  ...
  decisions; start with the [`4.0.0-rc.2` ledger](releases/4.0.0-rc.2.md).
