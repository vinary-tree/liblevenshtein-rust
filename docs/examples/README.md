...
| 07 | [Performance & Concurrency](07-performance/README.md) | Benchmark on a real 124k-word dictionary; backend trade-offs; the lock-free/RwLock read model | `real_world_benchmark.rs` |
