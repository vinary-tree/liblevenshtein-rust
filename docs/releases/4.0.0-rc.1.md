...
| `liblevenshtein-rust` | release branch includes the clean-source fix `d43cd83`; final tag awaits the commit containing this ledger | local default/all-feature suites passed; exact-tag validation pending | publication pending libdictenstein read-back |
| `lling-llang` | `4fffc88` in isolated `release/4.0.0-rc.1` worktree | tag validation run `32705526551` succeeded | publication pending Rust prerequisites |
| `duallity` | `60fb805` in isolated `release/4.0.0-rc.1` worktree | tag validation run `32705524747` succeeded | publication pending Rust prerequisites |
