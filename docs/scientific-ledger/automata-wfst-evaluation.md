...
| PHON-014b | `phon-014b-llev-english-homophone-observational-root-cause` | Fix the embedded `en-us-cmudict` profile by applying the broad CMUdict whole-word layer before general American English rules. | Correctness/root-cause gate; wall time was not used for conclusions. | Allocation metrics were collected but not used as decision evidence under this diagnostic gate. | Fixed `en-us-cmudict` matched 3768/3960 expected CMUdict homophone rows at recall@5 on the 2048-case slice, versus 2109/3960 for Zompist and 2086/3960 for American+homophones+names. Diagnostic buckets after the fix were 3768 retrieved, 147 top-k ceiling, 45 ambiguous-pronunciation ranking, 0 coverage gaps, and 0 normalized-index/query bugs. |
