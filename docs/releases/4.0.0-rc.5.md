...
**State:** coordinated RC.5 branches and pull requests exist at the initial
source-freeze commits. The first hosted-CI pass exposed sibling-ref and proof
toolchain defects. Corrective commits pass local causal reproductions and await
separate approval to push. No RC.5 tag or registry coordinate has been
published.
...
| remote validation | coordinated branches resolve to approved commits and protected workflows pass | initial branch readback passed; first PR runs failed for the recorded dependency/toolchain causes; local repairs await push approval |
...
The first hosted-CI repairs are committed locally and have not been pushed:
...
| `liblevenshtein-rust` | `7c3dc8739ea2b7e4d2bc48f182a9880d45fb4f83` | reusable coordinated family checkout |
