...
mod tests {
    ...
    fn test_right_most_single_position() {
        let positions = vec![UniversalPosition::<Standard>::new_i(0, 1, 2).expect("test fixture: UniversalPosition::new_i with valid args")];
        let rm = right_most(positions.iter()).expect("test fixture: right_most on non-empty iterator");
    ...
    fn test_right_most_multiple_positions() {
        ...
        let positions = vec![
            UniversalPosition::<Standard>::new_i(0, 1, 2).expect("test fixture: UniversalPosition::new_i with valid args"),
            UniversalPosition::<Standard>::new_i(-2, 2, 2).expect("test fixture: UniversalPosition::new_i with valid args"), // Maximum e - i
            UniversalPosition::<Standard>::new_i(-1, 1, 2).expect("test fixture: UniversalPosition::new_i with valid args"),
        ];
        let rm = right_most(positions.iter()).expect("test fixture: right_most on non-empty iterator");
    ...
    fn test_right_most_m_type_positions() {
        let positions = vec![
            UniversalPosition::<Standard>::new_m(0, 0, 2).expect("test fixture: UniversalPosition::new_m with valid args"),
            UniversalPosition::<Standard>::new_m(-1, 1, 2).expect("test fixture: UniversalPosition::new_m with valid args"), // e - i = 1 - (-1) = 2
        ];
        let rm = right_most(positions.iter()).expect("test fixture: right_most on non-empty iterator");
    ...
    fn test_diagonal_crossed_i_type() {
        ...
        let pos = UniversalPosition::<Standard>::new_i(0, 3, 3).expect("test fixture: UniversalPosition::new_i with valid args");
    ...
    fn test_diagonal_crossed_m_type() {
        ...
        let pos = UniversalPosition::<Standard>::new_m(-1, 2, 2).expect("test fixture: UniversalPosition::new_m with valid args");
    ...
    fn test_convert_i_to_m_with_offset() {
        ...
        let i_pos = UniversalPosition::<Standard>::new_i(0, 1, 2).expect("test fixture: UniversalPosition::new_i with valid args");
        let m_pos = convert_position(&i_pos, 3, 2).expect("doc/test fixture: convert_position with valid args");
        assert!(m_pos.is_m_type());
        assert_eq!(m_pos.offset(), 0);
    ...
    fn test_convert_m_to_i_with_offset() {
        ...
        let m_pos = UniversalPosition::<Standard>::new_m(-1, 1, 2).expect("test fixture: UniversalPosition::new_m with valid args");
        let i_pos = convert_position(&m_pos, 3, 2).expect("doc/test fixture: convert_position with valid args");
        assert!(i_pos.is_i_type());
    ...
    fn test_convert_invalid_result() {
        ...
        let i_pos = UniversalPosition::<Standard>::new_i(5, 5, 5).expect("test fixture: UniversalPosition::new_i with valid args");
    ...
    fn test_convert_preserves_errors() {
        ...
        let i_pos = UniversalPosition::<Standard>::new_i(0, 2, 2).expect("test fixture: UniversalPosition::new_i with valid args");
        let m_pos = convert_position(&i_pos, 3, 2).expect("doc/test fixture: convert_position with valid args");
        assert_eq!(m_pos.errors(), 2);

        let m_pos = UniversalPosition::<Standard>::new_m(0, 2, 2).expect("test fixture: UniversalPosition::new_m with valid args");
        let i_pos = convert_position(&m_pos, 3, 2).expect("doc/test fixture: convert_position with valid args");
    ...
    fn test_convert_roundtrip() {
        ...
        let i_pos = UniversalPosition::<Standard>::new_i(0, 0, 2).expect("test fixture: UniversalPosition::new_i with valid args");
        let m_pos = convert_position(&i_pos, 3, 2).expect("doc/test fixture: convert_position with valid args");
        let i_pos2 = convert_position(&m_pos, 3, 2).expect("doc/test fixture: convert_position with valid args");
