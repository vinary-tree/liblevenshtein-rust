...
GUIDES: dict[str, Guide] = {
    ...
    "python": Guide(
        ...
        "Python 3.10+",
        "Tier 1",
        "PyPI package `vinary-tree-liblevenshtein`",
    ...
    "dotnet": Guide(
        ...
        ".NET 8+ and current C#",
        "Tier 2",
        "NuGet package `VinaryTree.Liblevenshtein`",
    ...
    "go": Guide(
        ...
        "Go 1.25+ with cgo",
        "Tier 2",
        "Go module `github.com/vinary-tree/liblevenshtein-rust/bindings/go`",
    ...
    "ruby": Guide(
        ...
        "Ruby 3.3+",
        "Tier 2",
        "RubyGems package `vinary-tree-liblevenshtein`",
    ...
    "fortran": Guide(
        ...
        "Tier 2",
        "fpm package `vinary-tree-liblevenshtein`",
    ...
    "ocaml": Guide(
        ...
        "Tier 3",
        "opam package `vinary-tree-liblevenshtein`",
    ...
    "haskell": Guide(
        ...
        "GHC through Cabal",
        "Tier 3",
        "Hackage package `vinary-tree-liblevenshtein`",
    ...
    "lua": Guide(
        ...
        "Lua 5.4+",
        "Tier 3",
        "LuaRocks package `vinary-tree-liblevenshtein`",
...
INTEROP_PACKAGES = {
    ...
    "go": "Go module `github.com/vinary-tree/liblevenshtein-rust/vinary-tree-interop/bindings/go`",
