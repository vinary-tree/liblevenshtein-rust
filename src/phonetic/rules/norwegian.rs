...
pub fn base() -> &'static RuleSetChar {
    ...
    RULESET.get_or_init(|| {
        ...
        let file = crate::phonetic::llev::parse_str(content)
            .expect("Invalid embedded norwegian/base.llev - this is a bug in liblevenshtein");
        RuleSetChar::from_llev(&file)
            .expect("Failed to compile Norwegian base rules - this is a bug in liblevenshtein")
    })
}
...
mod tests {
    ...
    fn test_word_norge() {
        ...
        assert!(
            result.to_lowercase().contains('n') && result.contains('o'),
