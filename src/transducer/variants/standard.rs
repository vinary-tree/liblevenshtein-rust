...
use crate::transducer::transition::transition_standard_into;
use crate::transducer::variant::{AutomatonVariant, TransitionCtx};
use crate::transducer::Position;
use smallvec::SmallVec;

/// Standard unit-cost Levenshtein variant.
#[derive(Debug, Clone, Copy)]
pub(crate) struct StandardV;

impl AutomatonVariant for StandardV {
    type Params = ();
