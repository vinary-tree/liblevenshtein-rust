...
![Lazy simulation: states are materialised on demand as the query descends the dictionary, driven only by the characteristic vector.](../diagrams/traversal/lazy-simulation.svg)
