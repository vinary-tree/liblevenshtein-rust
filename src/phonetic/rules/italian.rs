...
pub fn base() -> &'static RuleSetChar {
    ...
    RULESET.get_or_init(|| {
        ...
        let file = crate::phonetic::llev::parse_str(content).expect(
            "Invalid embedded italian/base.llev - this indicates an internal invariant violation",
        );
        RuleSetChar::from_llev(&file).expect(
            "Failed to compile Italian rules - this indicates an internal invariant violation",
        )
    })
}
...
mod tests {
    ...
    fn test_c_softening_before_i() {
        ...
        assert!(
            result.contains("t͡ʃ") || result.contains("tsh"),
            "c before i should become t͡ʃ, got: {}",
            result
        );
    }
    ...
    fn test_c_softening_before_e() {
        ...
        assert!(
            result.contains("t͡ʃ") || result.contains("tsh"),
            "c before e should become t͡ʃ, got: {}",
            result
        );
    }
    ...
    fn test_g_softening_before_e() {
        ...
        assert!(
            result.contains("d͡ʒ"),
            "g before e should become DZH, got: {}",
            result
        );
    }
    ...
    fn test_g_softening_before_i() {
        ...
        assert!(
            result.contains("d͡ʒ"),
            "g before i should become DZH, got: {}",
            result
        );
    }
    ...
    fn test_gh_preserves_hard_g() {
        ...
        assert!(
            result.starts_with('G'),
            "gh before e should be G (hard), got: {}",
            result
        );
    }
    ...
    fn test_sc_before_e() {
        ...
        assert!(
            result.contains("ʃ"),
            "sc before e should become sh, got: {}",
            result
        );
    }
    ...
    fn test_sc_before_i() {
        ...
        assert!(
            result.contains("ʃ"),
            "sc before i should become sh, got: {}",
            result
        );
    }
    ...
    fn test_qu_pattern() {
        ...
        assert!(
            result.contains("kv") || result.contains("kw"),
            "qu should become kv or kw, got: {}",
            result
        );
    }
    ...
    fn test_geminate_preserved() {
        ...
        assert!(
            result.contains('f') && result.contains('t'),
            "double consonants should process correctly, got: {}",
            result
        );
    }
    ...
    fn test_cia_pattern() {
        ...
        assert!(
            result.contains("t͡ʃa") || result.contains("tsha"),
            "cia should become t͡ʃa, got: {}",
            result
        );
    }
    ...
    fn test_accent_normalization() {
        ...
        assert!(
            !result.contains('à'),
            "accents should be normalized, got: {}",
            result
        );
    }
